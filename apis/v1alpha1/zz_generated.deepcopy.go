...
func (in *ReplicaKeyStatus) DeepCopyInto(out *ReplicaKeyStatus) {
	*out = *in
	...
	if in.ReplicaKeyMetadata != nil {
		in, out := &in.ReplicaKeyMetadata, &out.ReplicaKeyMetadata
		*out = new(KeyMetadata)
		(*in).DeepCopyInto(*out)
	}
	if in.ReplicaPolicy != nil {
		in, out := &in.ReplicaPolicy, &out.ReplicaPolicy
		*out = new(string)
		**out = **in
	}
	if in.ReplicaTags != nil {
		in, out := &in.ReplicaTags, &out.ReplicaTags
		*out = make([]*Tag, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]

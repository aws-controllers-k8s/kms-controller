...
const (
	FinalizerString = "finalizers.kms.services.k8s.aws/ReplicaKey"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("replicakeys")

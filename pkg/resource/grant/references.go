...
func (rm *resourceManager) ResolveReferences(
	...
	if err == nil {
		err = resolveReferenceForKeyID(ctx, apiReader, namespace, ko)
	}
...
// identifier field.
func validateReferenceFields(ko *svcapitypes.Grant) error {
	if ko.Spec.KeyRef != nil && ko.Spec.KeyID != nil {
		return ackerr.ResourceReferenceAndIDNotSupportedFor("KeyID", "KeyRef")
	}
	if ko.Spec.KeyRef == nil && ko.Spec.KeyID == nil {
		return ackerr.ResourceReferenceOrIDRequiredFor("KeyID", "KeyRef")
	}
	return nil
}
...
// resource
func hasNonNilReferences(ko *svcapitypes.Grant) bool {
	return false || (ko.Spec.KeyRef != nil)
}

// resolveReferenceForKeyID reads the resource referenced
// from KeyRef field and sets the KeyID
// from referenced resource
func resolveReferenceForKeyID(
	ctx context.Context,
	apiReader client.Reader,
	namespace string,

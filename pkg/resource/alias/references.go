...
func (rm *resourceManager) ResolveReferences(
	...
	if err == nil {
		err = resolveReferenceForTargetKeyID(ctx, apiReader, namespace, ko)
	}
...
func resolveReferenceForTargetKeyID(
	...
	if ko.Spec.TargetKeyRef != nil && ko.Spec.TargetKeyRef.From != nil {
		...
		if arr == nil || arr.Name == nil || *arr.Name == "" {
			return fmt.Errorf("provided resource reference is nil or empty: TargetKeyRef")
		}
		obj := &svcapitypes.Key{}
